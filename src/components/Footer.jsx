    ...
    <footer className="border-t border-white/10 bg-[#050505] py-10">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-col items-center md:items-start">
          <div className="text-2xl font-bold tracking-widest uppercase mb-1" style={{ fontFamily: '"Rye", serif' }}>
            <span className="text-[#d4af37]">BULL</span> Barbershop
          </div>
          <p className="text-white/50 text-sm tracking-wide">Krapina, Hrvatska</p>
        </div>
        ...
        <div className="flex items-center gap-8">
          ...
          <a href="#top" className="px-6 py-2 rounded-full border border-white/20 text-white/70 hover:text-white hover:border-[#d4af37] transition-all text-xs font-medium uppercase tracking-widest">
            Na vrh ↑
          </a>
        </div>
